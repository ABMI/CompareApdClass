...
OhdsiRTools::checkUsagePackage("CompareApdClass")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/CompareApdClass.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CompareApdClass.pdf")
...
OhdsiRTools::createRenvLockFile("CompareApdClass")
